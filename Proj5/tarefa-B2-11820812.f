      PROGRAM ISING
            ...
            PARAMETER (L=60, N=10000, MED = 10000, beta = 3)
            ...
            OPEN(1,FILE='./B/b2ccmag.DAT',STATUS='UNKNOWN')
            OPEN(2,FILE='./B/b2ccene.DAT',STATUS='UNKNOWN')
            OPEN(3,FILE='./B/b2cclattice.DAT',STATUS='UNKNOWN')
